...
const int heading_motor_speed_PWM_pin    = 8
const int heading_motor_direction_A_pin  = 9
const int heading_motor_direction_B_pin  = 10

bool steering_motor_speed_PWM   = false
bool steering_motor_direction_A = false
bool steering_motor_direction_B = false
bool heading_motor_speed_PWM    = false
bool heading_motor_direction_A  = false
bool heading_motor_direction_B  = false
